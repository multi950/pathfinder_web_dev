...
const save_to_cookie = function(name, description, ancestry_name, ancestry_id, heritage_name, heritage_id, ancestry_ability_boost, ancestry_feat_id, class_name, class_id, subclass_id, class_ability_score, class_feat_id, skill, skill_modifier){
    ...
    writeClass(class_name, class_id, subclass_id, class_ability_score, class_feat_id, skill, skill_modifier);
}
...
const characters = getCharacters(email).then(data =>{
    ...
    character_p.innerHTML = " | " + ancestry_name + " | " + heritage_name + " | " + class_name + "";
